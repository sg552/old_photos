...
(function($) {
  ...
  $.fn.RSV.validate = function(event)
  {
    ...
    if (options.displayType == "display-html")
    {
      ...
      if (options.errorFieldClass != null)
      {
        ...
        //by Siwei: 去掉control-group 中的所有error
  ...
  function styleField(field, focus)
  {
    ...
    // by Siwei: at last, add css class: "control-group error" to the parent node.
    // its parent must be: <div class="control-group"></div>
